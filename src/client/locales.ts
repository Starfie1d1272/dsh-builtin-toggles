...
export const zh: Record<BuiltinTogglesLocaleKey, string> = {
  ...
  error: '内置插件暂时不可用。',
  retry: '重试',
  intro: '查看 DSH Web 的官方内置插件及其作用。只有经过审核的纯界面插件可以在这里开关；核心服务和 Agent 能力保持锁定。',
...
export const en: Record<BuiltinTogglesLocaleKey, string> = {
  ...
  retry: 'Retry',
  intro: 'View DSH Web’s official built-in plugins and what they do. Only audited pure-UI plugins can be toggled here; core services and Agent capabilities stay locked.',
