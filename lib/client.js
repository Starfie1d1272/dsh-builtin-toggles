	...
	factory: (require) => {
		...
		function EvidenceDetails({ capability, snapshot, t }) {
			...
			const fields = [
				...
				[t("profilePersistence"), capability.configuration.profileApplicability === "not-applicable" ? t("profileNotApplicable") : capability.configuration.profilePersistence.status === "writable" ? capability.configuration.profilePersistence.status : "reason" in capability.configuration.profilePersistence && capability.configuration.profilePersistence.reason !== void 0 ? `${capability.configuration.profilePersistence.status}: ${capability.configuration.profilePersistence.reason}` : capability.configuration.profilePersistence.status],
