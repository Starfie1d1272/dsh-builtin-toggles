window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function capabilityHasAnomaly(capability, snapshot) {
			return capability.verification !== "verified" || !capability.baseline.reviewed || !capability.official || snapshot.compatibility.findings.some((finding) => finding.id === capability.id);
		}
		function filterCapabilities(snapshot, filters) {
		...
		function buildDiagnostics(snapshot) {
			...
			return [
				...
				"findings:",
				...compatibility.findings.map((finding) => `- ${finding.scope}:${finding.code}${finding.id === void 0 ? "" : ` (${finding.id})`}`),
				"capabilities:",
		...
		function CapabilityCard({ capability, snapshot, busy, initiallyExpanded, domId, onMutate, t }) {
			...
			const displayName = capability.packageName.split("/").at(-1) ?? capability.packageName;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
						style: title,
						children: t("capabilityName", { name: displayName })
					}),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: muted,
						children: t("compatibilityExplain")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						style: muted,
						children: [
		...
		async function mutateAndRefresh(fetcher, id, action) {
		...
		function BuiltinTogglesTab({ t }) {
			...
			const visible = (0, react.useMemo)(() => view.status === "ready" ? filterCapabilities(view.snapshot, filters) : [], [view, filters]);
				...
				children: [
					...
					visible.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: visible.map((capability, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CapabilityCard, {
							domId: `capability-${capability.id}-${index}`,
							capability,
							snapshot,
		...
		const zh = {
			...
			compatibilityExplain: "未验证仅表示 Host 没有公开可绑定的运行时发布身份，并不表示系统损坏或 capability 不可用。",
		...
		const en = {
			...
			compatibilityHeading: "Compatibility / Doctor",
			compatibilityExplain: "Unverified only means the Host has not exposed a bindable runtime release identity. It does not mean the system is broken or a capability is unavailable.",
